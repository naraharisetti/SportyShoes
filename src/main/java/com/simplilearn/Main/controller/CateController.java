...
import com.simplilearn.Main.service.CateService;

@RestController
@RequestMapping("/MainPage/category")
public class CateController {
	...
	@PostMapping("")
	public ResponseEntity<Object> addUser(@RequestBody CateEntity entity){
		CateEntity resp=service.saveUser(entity);
		if(resp!=null)
	...
	public ResponseEntity<Object> getUserById(@PathVariable int id){
		CateEntity obj= service.getUserById(id);
		if(obj!=null)
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> updateUser(@RequestBody CateEntity entity,
			@PathVariable int id){
		CateEntity obj= service.updateUser(entity, id);
		if(obj!=null)
