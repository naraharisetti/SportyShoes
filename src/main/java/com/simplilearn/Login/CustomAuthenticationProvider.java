...
public class CustomAuthenticationProvider implements AuthenticationProvider{
	...
	List<UserEntity> dummyUsers= new ArrayList<UserEntity>();
	
	public CustomAuthenticationProvider() {
		dummyUsers.add(new UserEntity("user", "user123", "ROLE_USER"));
		dummyUsers.add(new UserEntity("admin", "admin123", "ROLE_ADMIN"));
	}
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		Optional<UserEntity> authenticatedUser= dummyUsers.stream().
